from service import *
from countryRepository import CountriesRepository
from categoriesRepository import CategoriesRepository
...
class UsersRepository:
    ...
    def __init__(self, db):
        ...
        self.countriesRepo = CountriesRepository(db) 
        self.categoryRepo = CategoriesRepository(db)

    # get lis of all services from database 
    ...
    def getServicesByUserId(self, userId):
        ...
        services = self.coll.find({"userId": userId})
